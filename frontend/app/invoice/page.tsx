    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-3">
        ...
        <section className="panel xl:col-span-2 p-5 md:p-6">
          ...
          <div className="pb-2">
            <div>
              <div className="mb-2 grid grid-cols-[minmax(0,1.8fr)_minmax(0,0.65fr)_minmax(0,0.85fr)_minmax(0,0.85fr)_minmax(0,1fr)_minmax(130px,1.05fr)_52px] gap-2 text-xs font-bold uppercase tracking-[0.14em] text-slate-600">
                <div>{t("Product")}</div>
                <div>{t("Pieces")}</div>
                <div>{t("Weight")}</div>
                <div>{t("Price")}</div>
              ...
              <div className="space-y-2">
                {items.map((item, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-[minmax(0,1.8fr)_minmax(0,0.65fr)_minmax(0,0.85fr)_minmax(0,0.85fr)_minmax(0,1fr)_minmax(130px,1.05fr)_52px] gap-2"
                  >
                    <select
                      className="field min-w-0 h-[52px] px-3 py-0 text-sm"
                    ...
                    <div className="flex min-w-0 h-[52px] items-center justify-center rounded-2xl bg-slate-100 px-2 text-sm font-black text-slate-950">
                    ...
                    <button
                      className="h-[52px] w-[52px] rounded-2xl bg-red-600 font-semibold text-white"
